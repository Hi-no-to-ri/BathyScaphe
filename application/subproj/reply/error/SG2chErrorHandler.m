...
static NSString *titleForCode(NSInteger code)
{
    ...
    } else if (code == k2chSPIDCookieErrorType) {
        return nil;
    }
    return @"ERROR";
}
...
//	[xpp_ setInputSource:htmlContents];
    NSString *fakeString = [htmlContents stringByReplaceCharacters:@"value=>" toString:@"value=\"\">"];
    [xpp_ setInputSource:fakeString];
    // ここまで暫定
	return xpp_;
}
