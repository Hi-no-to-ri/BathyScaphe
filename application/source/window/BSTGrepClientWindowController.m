...
//        m_soulGem = [[BSFind2chSoulGem alloc] init];
        m_soulGem = [[BSSyoboiSoulGem alloc] init];
    }
    return self;
}
...
- (IBAction)openSearchProvider:(id)sender
{
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"http://z.syoboi.jp/web/ff2ch/"]];
}
