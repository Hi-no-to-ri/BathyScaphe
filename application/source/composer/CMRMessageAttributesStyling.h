...
extern NSString *const BSSsspLinkScheme; // sssp
extern NSString *const BSInnerSsspLinkScheme; // bssssp
...
#define BSMessageKeyAttributeNameField @"name"
#define BSMessageKeyAttributeMailField @"mail"
#define BSMessageKeyAttributeIDField @"IDString"
#define BSMessageKeyAttributeHostField @"host"
#define BSMessageKeyAttributeMessageField @"cachedMessage"
