...
NSString *const SGHTMLViewLinkUserDataAttributeNameKey = @"AttributeName";
NSString *const SGHTMLViewLinkUserDataLinkValueKey = @"Link";
NSString *const SGHTMLViewLinkUserDataFieldHintKey = @"FieldHint";
...
//      doubleInterval = [interval_ doubleValue];
        doubleInterval = [NSEvent doubleClickInterval];
    ...
    if (NSLeftMouseDown == type){
        ...
        nextEvent_ = [[self window] nextEventMatchingMask:eventMask_
                                                untilDate:[NSDate dateWithTimeIntervalSinceNow:[NSEvent doubleClickInterval]]//MOUSE_CLICK_TRACKING_TIME]
                                                   inMode:NSEventTrackingRunLoopMode
                                                  dequeue:NO];
...
- (NSMenu *)linkMenuWithLink:(id)aLink
{
    ...
    menu_ = [[NSMenu alloc] initWithTitle:title_];
