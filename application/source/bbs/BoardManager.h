...
- (NSString *)BBSSlipValueForBoard:(NSString *)boardName; // Available in BathyScaphe 2.4.3 "Matatabi-Step" and later.
- (void)setBBSSlipValue:(NSString *)value forBoard:(NSString *)boardName; // Available in BathyScaphe 2.4.3 "Matatabi-Step" and later.
