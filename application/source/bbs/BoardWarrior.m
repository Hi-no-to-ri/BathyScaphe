...
NSString *const BoardWarriorDidFinishSyncingNotification = @"jp.tsawada2.BathyScaphe.BoardWarriorDidFinishSyncingNotification";
...
//    [[bm userList] reloadBoardFile:[bm userBoardListPath]];
    ...
    UTILNotifyName(BoardWarriorDidFinishSyncingNotification);
}
