...
- (id)copyWithZone:(NSZone *)aZone
{
    ...
    v = [[self referencingIndexes] copyWithZone:aZone];
    [tmp setReferencingIndexes:v];
    [v release];
...
- (NSIndexSet *)referencingIndexes
{
    return bs_referencingIndexes;
}

- (void)setReferencingIndexes:(NSIndexSet *)indexes
{
    [indexes retain];
    [bs_referencingIndexes release];
    bs_referencingIndexes = indexes;
}
...
//	return [CMXTextParser cachedMessageWithMessageSource:[self messageSource]];
    if (!bs_cachedMessage) {
        bs_cachedMessage = [[CMXTextParser cachedMessageWithMessageSource:[self messageSource] swapSsspScheme:YES] retain];
    }
