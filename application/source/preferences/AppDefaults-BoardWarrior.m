...
//  Copyright 2011-2015 BathyScaphe Project. All rights reserved.
//  encoding="UTF-8"
//
...
static NSString *const kBWBBSMenuURLKey = @"BoardWarrior:bbsmenu html URL";
...
- (NSURL *)BBSMenuURL
{
    NSString *urlString = [[self boardWarriorSettingsDictionary] objectForKey:kBWBBSMenuURLKey defaultObject:DEFAULT_BW_BBSMENU_URL];
...
- (void)setBBSMenuURL:(NSURL *)anURL
{
    ...
    [[self boardWarriorSettingsDictionary] setObject:urlString forKey:kBWBBSMenuURLKey];
}
