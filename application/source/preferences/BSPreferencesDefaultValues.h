...
#define DEFAULT_ABONDON_ALL_REPLY_TEXT_VIEW_FEATURES    NO
...
#define DEFAULT_TV_SHOWS_REF_MARKER             YES
#define DEFAULT_TV_SHOWS_NAVIGATION_BAR         YES
#define DEFAULT_TV_POPUP_TRIGGER_TYPE           BSPopupByContinuousMouseDown

// Accounts
#define DEFAULT_LOGIN_MARU_IF_NEEDED	NO
#define DEFAULT_LOGIN_BE_ANY_TIME		NO
#define DEFAULT_USE_KEYCHAIN			NO
#define DEFAULT_LOGIN_P22CH             NO
...
#define DEFAULT_TL_USES_RELATIVE_DATE_FORMAT    YES
...
#define DEFAULT_TTB_COLOR_STYLE         1
